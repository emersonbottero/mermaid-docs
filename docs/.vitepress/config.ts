...
function nav() {
  return [
    ...
    { text: 'Configuration', link: '/config/Tutorials', activeMatch: '/config/' },
    { text: 'Syntax', link: '/syntax/classDiagram', activeMatch: '/syntax/' },
    { text: 'Misc', link: '/misc/integrations', activeMatch: '/misc/' },
    { text: 'Community', link: '/community/n00b-overview', activeMatch: '/community/' },
    { text: '📝 Live Editor', link: '/edit' },
    {
      text: version,
      items: [
        {
  ...
  return [
    {
      ...
      items: [
        ...
        { text: 'Entity Relationship Diagram', link: '/syntax/entityRelationshipDiagram' },
